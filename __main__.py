...
def writeRecordsToDB(dataset, collectionName):
    if(len(dataset) > 0):
        collection= db.get_collection(collectionName, CODEC_OPTIONS)
...
writeRecordsToDB(dataset=products, collectionName="products")
